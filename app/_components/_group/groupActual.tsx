...
const ActualGroup = () => {
  return (
    <>
      <div className="flex justify-around items-center absolute bottom-5 left-10 z-10 bg-stone-700 w-[340px]">
        {/* full */}
        ...
        <div className="flex justify-center items-center">
          ...
          <div className="bg-slate-500 p-2 mx-2 border-2 border-white rounded">
            <FlagIcon />
          </div>
        </div>
        {/* chat / clan */}
